...
10. ORGANICO/COPERTI: se c'è una sezione sull'organico (coperti serviti, coperti per ora-lavoro, pattern per giorno), NON limitarti a confrontare col valore "sano" assoluto. Fai anche l'analisi RELATIVA sul caso specifico del locale: confronta il giorno/periodo coi suoi ALTRI giorni della settimana e col suo tipico storico (usa "pattern_settimanale", "giorno_piu_teso", "giorno_piu_scarico", "organico_oggi", i coperti attesi del giorno). La cosa utile è la DISCREPANZA rispetto alle abitudini del locale ("di martedì sei più tirato che negli altri giorni", "oggi hai messo più personale del solito per un lunedì"), non un giudizio su una soglia fissa. Se lo storico è scarso, dillo e non forzare conclusioni.
